  ...
  return (
    <div className="relative m-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg   shadow-md">
      ...
      <div className="mt-4 px-5 pb-5">
        ...
        <Link
          href="/produto"
          className="flex items-center justify-center rounded-md bg-slate-900 text-white px-5 py-2.5 text-center text-sm font-medium  hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300"
        >
          <svg
